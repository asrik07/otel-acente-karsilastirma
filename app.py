...
def canlı_veri_topla_etstur(giris, cikis, yetiskin, cookie_val):
    ...
    soup = canlı_html_kazı_with_cookie(base_url, f"JSESSIONID={cookie_val}; D_SID={cookie_val}")
    canlı_fiyatlar = {}
    if soup:
        pass
    return canlı_fiyatlar
...
def canlı_veri_topla_jolly(giris, cikis, yetiskin, cookie_val):
    ...
    soup = canlı_html_kazı_with_cookie(base_url, f"ASP.NET_SessionId={cookie_val}")
    canlı_fiyatlar = {}
    if soup:
        pass
    return canlı_fiyatlar
